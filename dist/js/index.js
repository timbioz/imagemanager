...
window.addEventListener("click", windowOnClick); //</editor-fold>

jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function (e) {
  console.log("dwidnwdwdwdwd");
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#imageUploadForm').on('submit', function (e) {
    e.preventDefault();
